...
import { demoAuth } from "../middlewares/auth";
import {
...
router.delete("/:id", demoAuth, ticketsController.deleteTicket);
router.put("/:id", demoAuth, validateUpdateTicket, ticketsController.updateTicket);
